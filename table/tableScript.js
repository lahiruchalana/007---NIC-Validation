...
var myArray = [
    ...
    {'name':'Shashini', 'NIC':'	962916243x', 'referralNIC':'', 'age':'24', 'birthdate':'10/31/1995'},
    {'name':'Iresh', 'NIC':'200135145412', 'referralNIC':'013515412v', 'age':'24', 'birthdate':'10/31/1995'},
    {'name':'Chalana', 'NIC':'	8129106243v', 'referralNIC':'', 'age':'24', 'birthdate':'10/31/1995'},
...
function searchTable(value, data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        if (name.includes(value)) {
            ...
            if (NIC.includes(value)) {
            ...
            else if (birthYearDOB.includes(valueBirthYearDOB)) {
                if (serialCode.includes(valueSerialCode)) {
                    ...
                    update.onclick = function() { // append new NIC value
